...
/*
TODO:
[ ] Produzir o código da função sbPushString
[ ] Produzir uma arquitetura para o banco de dados, talvez CSV, ou implementar leitura de arquivos JSON em C, ou utilizar de sqlit
...
/*
------------------------------------------------------------------------------------------------
                                PRODUCT DATBASE HANDLES CODE SECTION
------------------------------------------------------------------------------------------------
*/
